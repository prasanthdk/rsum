        ...
        <div class="col-lg-12">
            <table id="example" class="table table-striped table-bordered nowrap" style="width:100%">
                ...
                <tr>
                    ...
                    <td>-</td>
                    <td>
                        <a href="{{ url('admin/manage_user_view/'.Illuminate\Support\Facades\Crypt::encryptString($user_list->id))}}" data-toggle="tooltip" title="View" style="text-decoration: none"><i class="fa fa-eye"></i>&nbsp;&nbsp;&nbsp;</a>
