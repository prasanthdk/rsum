(function($) {
    $.TextOver = function(obj, options) {
        ...
        resizeTextArea = function(e) {
            var span = $("#helper");
            if (span.length < 1) span = $('<span id="helper"></span>');
            innerHTML = String($(this).val()).replace(/&/g, "&amp;").replace(/"/g, "&quot;").replace(/'/g, "&#39;").replace(/</g, "&lt;").replace(/>/g,
                "&gt;").replace(/\n/g, "<br />") + "...";
        ...
        handleEsc = function(e) {
            if (e.keyCode == 27) removeTextArea(messages.length - 1)
        };
