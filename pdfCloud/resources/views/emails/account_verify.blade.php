                ...
                <table style="margin: 0 auto;" cellspacing="0" cellpadding="0" class="force-width-80">
                  ...
                  <tr>
                    ...
                    <td style="text-align: center;">                    
                      ...
                      <h4>Hi <span style="color:#00d4ff;">Hi,</span>,<br><br></h4>

                      <!-- <span style="background-color: #f1eff2;padding: 7px 20px;text-align: center;border-radius: 3px;"> Info@linkaesthetics.com </span>  -->

                      <p style="line-height: 1.5;font-size:15px;">Thank you for registering an account with PDFCloud. We are excited to have you on board. Please click the link below to verify your email.</p>
